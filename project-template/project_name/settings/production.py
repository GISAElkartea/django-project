...
STATIC_ROOT = '/home/{{ project_name }}/webapps/static/static/'
STATIC_URL = '/files/static/'
MEDIA_ROOT = '/home/{{ project_name }}/webapps/static/media/'
MEDIA_URL = '/files/media/'
ADMIN_MEDIA_PREFIX = os.path.join(STATIC_URL, 'grappelli')

CACHE_BACKEND = 'memcached://unix:/home/{{ project_name }}/webapps/{{ project_name }}/memcached.sock'
...
EMAIL_HOST_USER = ''
EMAIL_HOST_PASSWORD = ''
DEFAULT_FROM_EMAIL = 'system@{{ project_name }}'
SERVER_EMAIL = 'system@{{ project_name }}'
